...
<div id="badges" align="center">
  ...
  <div align="center">
	  ...
	  <h3>Hey there! Welcome to HostingerMaintenanceAPI.</h3>
...
You can download by cloning the Git repository:
    ...
    git clone https://github.com/surelle-ha/HostingerMaintenanceAPI.git
   
Navigate to directory.

    cd HostingerMaintenanceAPI
...
Run using recommended launch script
 ...
 [![Deploy to Render](https://render.com/images/deploy-to-render-button.svg)](https://render.com/deploy?repo=https://github.com/surelle-ha/HostingerMaintenanceAPI.git)
